...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['accion'])) {
    if ($_POST['accion'] === 'crear_factura') {
        ...
        try {
            ...
            $stmt_factura->bind_param("ssssssdds", $numero_factura, $tipo, $tipo_comprobante, $cliente_id, $fecha_emision, $fecha_vencimiento, $subtotal, $iva, $total, $observaciones);
            ...
            if ($tipo_comprobante === 'factura') {
                ...
                $stmt_cc->bind_param("isdds", $cliente_id, $concepto, $factura_id, $total, $total, $fecha_emision);
                $stmt_cc->execute();
            }
...
<head>
    ...
    <style>
        ...
        #productos-factura { max-height: 300px; overflow-y: auto; }
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            switch($row['estado']) {
                                                ...
                                                case 'pagada': $badge_color = 'success'; break;
                                                case 'vencida': $badge_color = 'danger'; break;
                                                case 'anulada': $badge_color = 'secondary'; break;
                                            }
                                            ?>
                    ...
                    <div class="producto-item">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small>$${item.precio.toFixed(2)} x ${item.cantidad} = $${subtotal_item.toFixed(2)}</small>
                            </div>
                            <div class="btn-group">
